    ...
    <div class="layout-page">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url('Admin/savePaymentWater/'.$row->billno); ?>" method="POST">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label" for="">जल कर (वर्तमान)</label>
                                        <input type="number" name="" class="form-control" value="<?= $row->arv_water; ?>" required/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label" for="">बकाया/ सरचार्ज</label>
                                        <input type="number" name="" class="form-control" value="<?= $row->opening_arrear_water; ?>" required/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label" for="">अग्रिम / अधिभार कर</label>
                                        <input type="number" name="" class="form-control" value="<?= $row->opening_advance_water; ?>" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label" for="">कुल देय जल कर</label>
                                        <input type="number" name="total_tax" id="total_tax" class="form-control" value="<?= $row->curr_arrear_water; ?>" required/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="payment_id" class="form-control" value="<?php $payment_id=rand(1000000, 9999999); echo "WATERTAX-".$payment_id; ?>" />
                                    </div>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary">Submit</button>
                            <a href="<?= base_url('Admin/payWaterTaxList'); ?>" class="btn btn-secondary">Go Back</a>
                        </form>
                    </div>
                </div>
                <?php } else { ?>
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">जल कर बकाया सूची</h5>
                        <small class="float-end">
                            <a href="<?= base_url('Admin/payWaterTax'); ?>" class="btn btn-primary">
                                वापस जाएं
                            </a>
                        </small>
                    </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn rounded-pill btn-outline-danger" href="<?= base_url('Admin/payTaxWater/'.$value['billno']); ?>"> जमा करें</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
