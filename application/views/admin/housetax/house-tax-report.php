    ...
    <div class="layout-page">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <h4 class="text-muted">भवन कर रिपोर्ट</h4>
                <div class="nav-align-top mb-4">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="navs-pills-justified-defaulter" role="tabpanel">
                            <form action="<?= base_url('Admin/getDefaulterList'); ?>" method="POST">
                        ...
                        <div class="tab-pane fade" id="navs-pills-justified-year" role="tabpanel">
                            <form action="<?= base_url('Admin/getListYearWise'); ?>" method="POST">
                                <div class="row clearfix">
                        ...
                        <div class="tab-pane fade" id="navs-pills-justified-ward" role="tabpanel">
                            <form action="<?= base_url('Admin/getListWardWise'); ?>" method="POST">
                                <div class="row clearfix">
                                    <div class="col-md-4"></div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                        ...
                        <div class="tab-pane fade" id="navs-pills-justified-date" role="tabpanel">
                            <form action="<?= base_url('Admin/getListDateWise'); ?>" method="POST">
                                <div class="row clearfix">
                                    <div class="col-md-3"></div>
                                    <div class="col-md-3">
                                        <div class="mb-3">
