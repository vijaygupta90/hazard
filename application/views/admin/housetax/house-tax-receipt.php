    ...
    <body>
        <div style="display: flex; padding-top:20px;">
            <table width="100%" border="1" cellpadding="3" cellspacing="0">
            	<tr>
            	    <td colspan="2" align="center" style="font-size:40px"><b>नगर पंचायत सुरियावाँ,भदोही उ0प्र0</b><br><span style="font-size:18px; font-weight: 600;">भवन कर रसीद</span><br /><span>Form No. 5</span></td>
            	</tr>
            	<tr>
        ...
        <a href="<?php echo base_url().'Admin/getTaxReceiptList'; ?>" id="printPageButton" class="btn btn-secondary footer-btn">Go Back</a>
    </body>
</html>