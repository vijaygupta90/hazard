...
<html lang="en">
    <head>
    	...
    	<title>नगर पंचायत सुरियावाँ ,भदोही</title>
    ...
    <body>
        <div style="display: flex; padding-top:20px;">
        	<table width="100%" border="1" cellpadding="3" cellspacing="0">
				<tr>
					<td align="right">Original Copy</td>
				</tr>
            	<tr>
            	    <td colspan="2" align="center" style="font-size:40px"><b>नगर पंचायत सुरियावाँ,भदोही उ0प्र0</b><br><span style="font-size:18px; font-weight: 600;">भवन कर बिल</span></td>
            	</tr>
            	<tr>
            	    ...
            	    <td colspan="2">
                    	...
                    	<table width="100%" border="1" cellpadding="3" cellspacing="0">
                        	...
                        	<tr>
                            	...
                            	<td align="center">भवन कर (वा0 मू0 - <?= $demand->arv; ?> )</td>
                            	<td align="right"><?= $demand->arv; ?></td>
                        	</tr>
                            <tr>
                        ...
                        <span style="float: right;">
                            अधिशासी अधिकारी <br />
                            नगर पंचायत सुरियावां,भदोही उ0प्र0
                        </span>
                    </td>
        	    </tr>
        	</table>&nbsp;&nbsp;
        ...
        <a href="<?php echo base_url().'Admin/houseTaxDemandList'; ?>" id="printPageButton" class="btn btn-secondary footer-btn">Go Back</a>
    </body>
</html>