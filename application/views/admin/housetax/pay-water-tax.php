            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">वार्ड अनुसार जल कर जमा करें</h5>
                        <small class="float-end">
                            <a href="<?= base_url('Admin/getWaterTaxReceipt'); ?>" class="btn btn-primary">
                                रसीद निकालें
                            </a>
                        </small>
                    </div>
                    <div class="card-body">
                        <form action="<?= base_url('Admin/payWaterTaxList'); ?>" method="POST">
