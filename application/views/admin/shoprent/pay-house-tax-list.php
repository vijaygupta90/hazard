        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4">
                    <span class="text-muted fw-light">दुकान किराया /</span> कर जमा करें
                </h4>
                <!-- Table -->
                <?php if(isset($row)){ ?>
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url('Shoprent/savePayment/'.$row->billno); ?>" method="POST">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="ward_no" class="select2 form-select hindi" required>
                                            <?php
                                                $query = $this->db->get_where('shoprent_ward')->result_array();
                                                foreach ($query as $key => $value) {
                                            ?>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label" for="">दुकान किराया (वर्तमान)</label>
                                        <input type="number" name="rent" class="form-control" value="<?= $row->rent; ?>" required/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                            ...
                            <a href="<?= base_url('Shoprent/payShopRentList'); ?>" class="btn btn-secondary">वापस जाएं</a>
                        </form>
                    </div>
                </div>
                <?php } else { ?>
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">दुकान किराया बकाया सूची</h5>
                        <small class="float-end">
                            <a href="<?= base_url('Shoprent/payShopRent'); ?>" class="btn btn-primary">
                                वापस जाएं
                            </a>
                        </small>
                    </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn rounded-pill btn-outline-danger" href="<?= base_url('Shoprent/payTax/'.$value['billno']); ?>"> जमा करें</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
