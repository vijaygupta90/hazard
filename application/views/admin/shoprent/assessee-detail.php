        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('Shoprent/assesseeListWardWise'); ?>" method="POST">
                    ...
                    <div class="modal-dialog modal-fullscreen" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?= base_url('Shoprent/addAssessee'); ?>" method="POST">
                                    <div class="row clearfix">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <?php $crn = $this->db->select('*')->from('shoprent_registrations')->order_by('id', 'DESC')->get()->row(); ?>
