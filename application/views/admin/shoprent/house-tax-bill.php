...
<html lang="en">
    ...
    <body>
        ...
        <table width="100%" border="1" cellpadding="3" cellspacing="0">
            	<tr>
            	    <td colspan="2" align="center" style="font-size:40px"><b>नगर पालिका परिषद् बदायूं, उत्तर प्रदेश</b><br><span style="font-size:18px; font-weight: 600;">दुकान किराया बिल</span></td>
            	</tr>
            	<tr>
            	    ...
            	    <td colspan="2">
                	    <table width="100%" cellpadding="3">
                        	<tr>
                            	...
                            	<td width="50%">
									<?php $ward = $this->db->select('*')->from('shoprent_ward')->where('ward_no', $demand->ward_no)->get()->row(); ?>
                    	...
                    	<table width="100%" border="1" cellpadding="3" cellspacing="0">
                        	...
                        	<tr>
                            	...
                            	<td align="center">दुकान किराया (वा0 मू0 - <?= $demand->rent; ?> )</td>
        ...
        <a href="<?php echo base_url().'Shoprent/houseTaxDemandList'; ?>" id="printPageButton" class="btn btn-secondary footer-btn">Go Back</a>
    </body>
</html>