        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4">
                    <span class="text-muted fw-light">दुकान किराया /</span> कर रसीद प्राप्त करें
                </h4>
                <!-- Table -->
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">वार्ड अनुसार दुकान किराया रसीद प्राप्त करें</h5>
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('Shoprent/getTaxReceiptList'); ?>" method="POST">
