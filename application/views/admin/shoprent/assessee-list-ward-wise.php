        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4">
                    <span class="text-muted fw-light">दुकान किराया /</span> उपभोक्ता विवरण
                </h4>
                <!-- Table -->
                <?php if(isset($update_detail)){ ?>
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url('Shoprent/updateAssesseeDetail/shoprent_registrations/'.$update_detail['id']); ?>" method="POST">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <small class="float-end">
                            <a href="<?= base_url('Shoprent/assesseeDetailShop'); ?>" class="btn btn-primary">
                                वापस जाएं
                            </a>
                        </small>
                    </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('Shoprent/editAssesseeDetail/shoprent_registrations/'.$value['id']); ?>"><i class="bx bx-edit-alt me-1"></i> अपडेट करें</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
