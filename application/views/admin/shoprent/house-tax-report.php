        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4">
                    <span class="text-muted fw-light">दुकान किराया /</span> रिपोर्ट निकालें
                </h4>
                <h6 class="text-muted">रिपोर्ट</h6>
                <div class="nav-align-top mb-4">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="navs-pills-justified-defaulter" role="tabpanel">
                            <form action="<?= base_url('Shoprent/getDefaulterList'); ?>" method="POST">
                        ...
                        <div class="tab-pane fade" id="navs-pills-justified-year" role="tabpanel">
                            <form action="<?= base_url('Shoprent/getListYearWise'); ?>" method="POST">
                                <div class="row clearfix">
                        ...
                        <div class="tab-pane fade" id="navs-pills-justified-ward" role="tabpanel">
                            <form action="<?= base_url('Shoprent/getListWardWise'); ?>" method="POST">
                                <div class="row clearfix">
                                    <div class="col-md-4"></div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                        ...
                        <div class="tab-pane fade" id="navs-pills-justified-date" role="tabpanel">
                            <form action="<?= base_url('Shoprent/getListDateWise'); ?>" method="POST">
                                <div class="row clearfix">
                                    <div class="col-md-3"></div>
                                    <div class="col-md-3">
                                        <div class="mb-3">
