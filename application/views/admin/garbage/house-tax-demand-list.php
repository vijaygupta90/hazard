        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4">
                    <span class="text-muted fw-light">ठोस अपशिष्ट कर /</span> कर की मांग
                </h4>
                <!-- Table -->
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">ठोस अपशिष्ट कर मांग सूची</h5>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn rounded-pill btn-outline-danger" href="<?= base_url('Garbage/printBill/'.$value['billno']); ?>"> <?= $value['billno']; ?></a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
