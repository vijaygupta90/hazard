    ...
    <div class="layout-page">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url('Garbage/savePayment/'.$row->billno); ?>" method="POST">
                            ...
                            <a href="<?= base_url('Garbage/payGarbageList'); ?>" class="btn btn-secondary">वापस जाएं</a>
                        </form>
                    </div>
                </div>
                <?php } else { ?>
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <small class="float-end">
                            <a href="<?= base_url('Garbage/payGarbage'); ?>" class="btn btn-primary">
                                वापस जाएं
                            </a>
                        </small>
                    </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn rounded-pill btn-outline-danger" href="<?= base_url('Garbage/payTax/'.$value['billno']); ?>"> जमा करें</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
