    ...
    <body>
        <div style="display: flex; padding-top:20px;">
            <table width="100%" border="1" cellpadding="3" cellspacing="0">
            	<tr>
            	    <td colspan="2" align="center" style="font-size:40px"><b>नगर पालिका परिषद् बदायूं, उत्तर प्रदेश</b><br><span style="font-size:18px; font-weight: 600;">ठोस अपशिष्ट कर रसीद</span><br /><span>Form No. 5</span></td>
            	</tr>
            	<tr>
                	<td style="display: flex;justify-content: space-between;"><b>रसीद की तिथि : <?php $originalDate = $demand->created_at; $newDate = date("d-m-Y", strtotime($originalDate)); echo $newDate; ?></b> </td>
            	</tr>
            	<tr>
            	    <td colspan="2">
                    	...
                    	<table width="100%" border="1" cellpadding="3" cellspacing="0">
                        	...
                        	<tr>
                            	...
                            	<td align="center">कुल ठोस अपशिष्ट कर </td>
        ...
        <a href="<?php echo base_url().'Garbage/getTaxReceiptList'; ?>" id="printPageButton" class="btn btn-secondary footer-btn">Go Back</a>
    </body>
</html>