        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4">
                    <span class="text-muted fw-light">ठोस अपशिष्ट कर /</span> कर गणना
                </h4>
                <!-- Table -->
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">कर गणना करें</h5>
                        <small class="float-end">
                            <a href="<?= base_url('Garbage/houseTaxDemand'); ?>" class="btn btn-primary">
                                कर की मांग
                            </a>
                        </small>
                    </div>
                    <div class="card-body">
                        <form action="<?= base_url('Garbage/houseTaxCalcList'); ?>" method="POST">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label" for="">प्रारम्भिक पंजीकरण संख्या</label>
                                        <input type="number" name="from_crn" class="form-control" value="" required/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label" for="">अन्तिम पंजीकरण संख्या</label>
                                        <input type="number" name="to_crn" class="form-control" value="" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
