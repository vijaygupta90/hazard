        ...
        <!-- Vendors JS -->
        <script src="<?= base_url(); ?>assets/admin/vendor/libs/apex-charts/apexcharts.js"></script> <!-- Main JS -->
        <script src="<?= base_url(); ?>assets/admin/js/main.js"></script> <!-- Page JS -->
        <script src="<?= base_url(); ?>assets/admin/js/dashboards-analytics.js"></script> <!-- Place this tag in your head or just before your close body tag. -->
