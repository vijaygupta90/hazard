    ...
    <div class="layout-page">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url('Mutation/updateWard/mutation_ward/'.$update_ward['id']); ?>" method="POST">
                            <div class="mb-3">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('Mutation/editWard/mutation_ward/'.$value['id']); ?>"><i class="bx bx-edit-alt me-1"></i> अपडेट करें</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?= base_url('Mutation/addWard'); ?>" method="POST">
                                    <div class="mb-3">
                                        <label class="form-label" for="">वार्ड का नाम</label>
                                        <input type="text" name="ward_name" class="form-control hindi" id="" required/>
                                        <?php $ward = $this->db->select('*')->from('mutation_ward')->order_by('id', 'DESC')->get()->row(); ?>
